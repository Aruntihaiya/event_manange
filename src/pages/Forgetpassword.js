...
export default function Forgetpassword() {
  const navigate = useNavigate();
    ...
    const apicalling = () => {
      axios.post("http://192.168.29.28:8080/api/public/forgetpassword",{
    ...
    <Container>
        <div className="account-area mt-5">
          <div className="section-header-3">
            ...
            <span className="cate">Forget Your Password?</span>
          ...
          <div className='back-to-home'><span><BsArrowLeft/></span><NavLink to="/Signin">Back To Login</NavLink></div>
        </div>
    </Container>
  </section>
  )
